...
Audit date: 2026-08-28. Counts use whitespace-delimited words. The page uses
**simulation** for the activity, **system** for a water/power/bakery choice,
**fault** for a disruptive event, **controls** for inputs, **Watch mode** for
the walkthrough, and **settings** for values in a link.
...
The h1 starts with a verb, has six words, and the adjacent audience sentence
has 16 words. All sentences are at or below 22 words. The banned-word scan for
