# How It Runs: 5-minute browser simulators of everyday jobs and systems, built to explain 'what do you actually do?' to ki (`how-it-runs`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://how-it-runs.sociobot.in`. Artifact class: `static-web`.
